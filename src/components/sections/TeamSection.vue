...
<script lang="ts">
/**
 * Секция «Команда» (TeamSection).
 * Показывает карточки ключевых участников команды с фото и должностями.
 * Данные сейчас захардкожены в шаблоне. При масштабировании проекта стоит
 * вынести их в props/JSON/API.
 */
export default {
  name: 'TeamSection'
}
